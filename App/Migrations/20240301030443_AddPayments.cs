...
namespace App.Migrations
{
  ...
  public partial class AddPayments : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          CapturedAmount = table.Column<decimal>(
            type: "numeric(16,8)",
            precision: 16,
            scale: 8,
            nullable: false
      ...
      migrationBuilder.InsertData(
        ...
        values:
        [
          new Guid("7faf2b28-a953-4fe1-8d3f-408299e04c33"),
          14m,
          new DateTime(2024, 3, 1, 3, 4, 43, 598, DateTimeKind.Utc).AddTicks(3460),
        ]
      );
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropIndex(name: "IX_Transactions_PaymentId", table: "Transactions");
      ...
      migrationBuilder.InsertData(
        ...
        values: 
        [
          new Guid("2038d689-2741-44a6-ba79-66376940e0de"),
          14m,
          new DateTime(2024, 2, 28, 16, 27, 44, 182, DateTimeKind.Utc).AddTicks(4320),
        ]
      );
    }
  }
