...
{
  // Data -> Domain
  public static DiscountMatchMode ToDiscountMatchMode(this string data) => data switch
  {
  ...
  public static DiscountMatchType ToDiscountMatchType(this string data) => data switch
  {
  ...
  public static DiscountType ToDiscountType(this string data) => data switch
  {
  ...
  public static DiscountStatus ToStatus(this DiscountData data) => new() { Disabled = data.Disabled, };

  public static DiscountTarget ToTarget(this DiscountData data) => new()
  {
    MatchMode = data.Target.MatchMode.ToDiscountMatchMode(),
    Matches = data.Target.Matches.Select(x => new DiscountMatch
    {
  ...
  public static DiscountRecord ToRecord(this DiscountData data) => new()
  {
    Amount = data.Amount,
  ...
  public static DiscountPrincipal ToPrincipal(this DiscountData data) => new()
  {
    Id = data.Id,
  ...
  // Domain -> Data 
  public static string ToData(this DiscountType domain) => domain switch
  {
  ...
  public static string ToData(this DiscountMatchMode domain) => domain switch
  {
  ...
  public static string ToData(this DiscountMatchType domain) => domain switch
  {
  ...
  public static DiscountData UpdateData(this DiscountData data, DiscountTarget target)
  {
    ...
    data.Target.Matches = target.Matches.Select(x => new DiscountMatchData { Type = x.Type.ToData(), Value = x.Value, })
      .ToList();
    return data;
  }
