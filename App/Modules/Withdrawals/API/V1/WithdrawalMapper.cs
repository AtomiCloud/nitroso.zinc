...
{
  // Domain -> RES
  public static string ToRes(this WithdrawStatus status) => status switch
  {
  ...
  public static WithdrawalStatusRes ToRes(this WithdrawalStatus status) => new(status.Status.ToRes());
  ...
  // REQ -> Domain
  public static WithdrawStatus ToWithdrawStatus(this string status) => status switch
  {
