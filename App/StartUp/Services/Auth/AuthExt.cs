...
{
  public static void AddAllScope(
    this IList<IAuthorizationRequirement> req,
    string domain,
    string field,
  ...
  public static void AddAnyScope(
    this IList<IAuthorizationRequirement> req,
    string domain,
    string field,
    params string[] scopes
  ...
  public static Unauthorized RequirementToProblem(
    this HasAllRequirement requirement,
    string detail,
    string field,
  ...
  public static Unauthorized RequirementToProblem(
    this HasAnyRequirement requirement,
    string detail,
    string field,
    IEnumerable<string>? scopes
  )
  ...
  {
    context.Items[Constants.ProblemContextKey] = requirement.RequirementToProblem(
      detail,
      field,
      scopes
    );
