...
{
  // Domain -> RES
  public static string ToRes(this TrainDirection direction) =>
    direction switch
    {
  ...
  public static TimingPrincipalRes ToRes(this TimingPrincipal principal) =>
    new(
      principal.Direction.ToRes(),
      principal.Record.Timings.Select(x => x.ToStandardTimeFormat()).ToArray()
    );

  public static TimingRes ToRes(this Timing timing) => new(timing.Principal.ToRes());

  // REQ -> Domain
  public static TrainDirection DirectionToDomain(this string direction) =>
    direction switch
    {
