...
{
  // RES
  public static string ToRes(this TransactionType type) => type switch
  {
  ...
  public static TransactionPrincipalRes ToRes(this TransactionPrincipal transaction)
    => new(transaction.Id, transaction.CreatedAt, transaction.Record.Name,
  ...
  // REQ
  public static TransactionType ToTransactionType(this string type) => type switch
  {
