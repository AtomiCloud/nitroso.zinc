...
{
  // Domain -> RES
  public static string ToRes(this DiscountType type) => type switch
  {
  ...
  public static string ToRes(this DiscountMatchMode mode) => mode switch
  {
  ...
  public static string ToRes(this DiscountMatchType type) => type switch
  {
  ...
  public static DiscountTargetRes ToRes(this DiscountTarget target) =>
    new(
      target.MatchMode.ToRes(),
      target.Matches
        .Select(m => m.ToRes()).ToArray()
    );
  ...
  public static DiscountStatusRes ToRes(this DiscountStatus status) =>
    new(status.Disabled);
  ...
  // REQ -> Domain
  public static DiscountType ToDiscountType(this string type) => type switch
  {
  ...
  public static DiscountMatchMode ToDiscountMatchMode(this string mode) => mode switch
  {
  ...
  public static DiscountMatchType ToDiscountMatchType(this string type) => type switch
  {
