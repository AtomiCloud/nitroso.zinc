...
public static class TimingMapper
{
  ...
  public static TimingPrincipal ToPrincipal(this TimingData data) =>
    new() { Direction = data.Direction.ToTrainDirection(), Record = data.ToRecord() };

  public static Timing ToDomain(this TimingData data) => new() { Principal = data.ToPrincipal() };

  public static TrainDirection ToTrainDirection(this int d) =>
    d switch
    {
  ...
  public static TimingData ToData(this TimingRecord record) =>
    new() { Timings = record.Timings.ToArray() };
