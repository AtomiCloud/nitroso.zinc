...
{
  [Authorize, HttpGet]
  public async Task<ActionResult<IEnumerable<TransactionPrincipalRes>>> Search([FromQuery] SearchTransactionQuery query)
  {
    var x = await this.GuardOrAnyAsync(query.userId, AuthRoles.Field, AuthRoles.Admin)
      .ThenAwait(_ => transactionSearchQueryValidator.ValidateAsyncResult(query, "Invalid TransactionSearchQuery"))
  ...
  public async Task<ActionResult<TransactionRes>> Get(Guid id, string? userId)
  {
    ...
    return this.ReturnNullableResult(wallet, new EntityNotFound(
      "Transaction Not Found", typeof(Transaction), id.ToString()));
  }
  ...
  public async Task<ActionResult<TransactionRes>> Delete(Guid id)
  {
    ...
    return this.ReturnUnitNullableResult(r, new EntityNotFound(
      "Transaction Not Found", typeof(Transaction), id.ToString()));
  }
