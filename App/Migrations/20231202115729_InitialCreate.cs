    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            JToWExcluded = table.Column<TimeOnly[]>(type: "time without time zone[]", nullable: false),
            WToJExcluded = table.Column<TimeOnly[]>(type: "time without time zone[]", nullable: false)
          },
          constraints: table =>
          {
